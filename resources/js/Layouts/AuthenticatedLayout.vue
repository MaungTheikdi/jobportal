                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('jobmanager')" 
                                :active="route().current('jobmanager')">
                                    job
                                </NavLink>

                                <NavLink :href="route('employersmanager')" 
                                :active="route().current('employersmanager')">
                                    employers
                                </NavLink>

                                
                                <NavLink :href="route('candidates')" 
                                :active="route().current('candidates')">
                                    candidates
                                </NavLink>

                                <NavLink :href="route('jobs')" 
                                :active="route().current('jobs')">
                                    job
                                </NavLink>

                                
                                <NavLink :href="route('applications')" 
                                :active="route().current('applications')">
                                    applications
                                </NavLink>

                                <!-- <NavLink :href="route('matches.index')" 
                                :active="route().current('matches.index')">
                                    ပွဲစဉ်များ
                                </NavLink> -->

                                <!-- Generate General Dropdown NavLink -->
